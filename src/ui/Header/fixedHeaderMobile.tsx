...
function FixedHeaderMobile({ setShowDashboard }: any) {

    const [show, setShow] = useState(false);
    // console.log('setShowDashboard', setShowDashboard);
    // useEffect(() => {
    ...
    return (
        <div
            className={`md:hidden fixed top-0 grid grid-cols-3 opacity-100 border-t-[1px] dark:border-0 p-3 items-center dark:bg-[#1B1F2B] dark:text-[white] bg-white z-[5] w-full transition-all duration-700 shadow-[0_0_15px_rgba(51,51,51,.15)] dark:shadow-[0_0_15px_gray]`}
        >
            <button onClick={() => setShowDashboard(true)}>
                <Image src={'/images/menu.png'} alt="dashboard" width={25} height={25} />
            </button>
            <Image
                className=""
                width={100}
